            ...
            <div class="header-part-right">
                ...
                <div class="dropdown">
                    <div class="user col align-self-end">
                        <img src="https://membership.nesog.org.np/backend/dist-assets/images/logout.png"
        ...
        <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                    ...
                    <li class="nav-item" data-item="maghFaram"><a class="nav-item-hold" href="#"><i
                                class="nav-icon i-Bar-Chart"></i><span class="nav-text">Magh Faram</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" data-item="kharidAadesh"><a class="nav-item-hold" href="#"><i
                                class="nav-icon i-Bar-Chart"></i><span class="nav-text">Kharid Aadesh</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item"><a class="nav-item-hold" href="{{ route('fiscalYear.index') }}"><i
                                class="nav-icon i-Calendar-2"></i><span class="nav-text">Fiscal Year</span></a>
                        <div class="triangle"></div>
                    </li>
                    <li class="nav-item" data-item="budget"><a class="nav-item-hold" href="#"><i
                                class="nav-icon i-Financial"></i><span class="nav-text">Budget</span></a>
                        <div class="triangle"></div>
                    </li>
                    {{--                        @endif --}}
                    {{--                    @endforeach --}}
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <ul class="childNav" data-parent="maghFaram">
                    <li class="nav-item"><a href="{{ route('maghFaram.create') }}"><i
                                class="nav-icon i-Clock-3"></i><span class="item-name">Create</span></a></li>
                    <li class="nav-item"><a href="{{ route('maghFaram.index') }}"><i
                                class="nav-icon i-Clock-3"></i><span class="item-name">List</span></a></li>
                </ul>
                <ul class="childNav" data-parent="kharidAadesh">
                    <li class="nav-item"><a href="{{ route('kharidAadesh.create') }}"><i
                                class="nav-icon i-Clock-3"></i><span class="item-name">Create</span></a></li>
                    <li class="nav-item"><a href="{{ route('kharidAadesh.index') }}"><i
                                class="nav-icon i-Clock-3"></i><span class="item-name">List</span></a></li>
                </ul>
                <ul class="childNav" data-parent="budget">
                    <li class="nav-item"><a href="{{ route('budget.create') }}"><i
                                class="nav-icon i-Clock-3"></i><span class="item-name">Create</span></a></li>
                    <li class="nav-item"><a href="{{ route('budget.index') }}"><i
                                class="nav-icon i-Clock-3"></i><span class="item-name">List</span></a></li>
                </ul>
            </div>
            ...
            <div class="app-footer">
                ...
                <div class="footer-bottom border-top pt-3 d-flex flex-column flex-sm-row align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="logo" src="https://omwaytechnologies.com/frontend/assets/img/omway.png"
                            alt="">
                        <div>
